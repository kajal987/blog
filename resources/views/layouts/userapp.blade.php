    ...
    <header class="main-header">
        ...
        <a href="{{ route('home') }}" class="logo">
            ...
            @if(file_exists(public_path('uploads/').Auth::user()->profilePicture) && Auth::user()->profilePicture)
                <img src="{{ url('uploads/'. Auth::user()->profilePicture) }}" class="profilepic2 img-circle" alt="User Image" style="height: 35px;">
            @else
                <img src="{{ url('uploads/defaultUser.png') }}" class="profilepic2 img-circle" alt="User Image" style="height: 35px;">
            @endif
        </a>
                        ...
                        @else
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    @if(file_exists(public_path('uploads/').Auth::user()->profilePicture) && Auth::user()->profilePicture)
                                        <img src="{{ url('uploads/'. Auth::user()->profilePicture) }}" class="profilepic2 img-circle" alt="User Image">
                                    @else
